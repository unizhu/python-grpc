...
class GreetingStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SayHello = channel.unary_unary(
        '/Greeting/SayHello',
        request_serializer=calculator__pb2.Name.SerializeToString,
        response_deserializer=calculator__pb2.Hello.FromString,
        )
...
def add_GreetingServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'SayHello': grpc.unary_unary_rpc_method_handler(
          servicer.SayHello,
          request_deserializer=calculator__pb2.Name.FromString,
          response_serializer=calculator__pb2.Hello.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
